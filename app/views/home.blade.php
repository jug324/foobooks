...
<h1>Developer's Best Friend</h1>
	<p>Below are links to 2 different tools that will help create content for users.</p>
<h2>Lorem Ipsum Generator</h2>
<p>The first tool is a Lorem Ipsum text generator. Lorem Ipsum is placeholder text usually used by web developers when building websites to show where contact will be placed without having to use specific content. The generator will create a number of paragraphs of Lorem Ipsum text based on user's choice.</p> 
